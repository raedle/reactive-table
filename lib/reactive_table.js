...
var setup = function () {
    ...
    console.log(Utils.isCollection(collection));
    ...
    if (!Utils.isCollection(collection)) {
        if (_.isArray(collection)) {
            ...
            console.error("reactiveTable error: argument is not an instance of Mongo.Collection, FS.Collection, a cursor, or an array");
            collection = new Mongo.Collection(null);
        }
    }
